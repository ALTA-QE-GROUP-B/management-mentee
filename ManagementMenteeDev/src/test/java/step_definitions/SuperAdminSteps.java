...
public class SuperAdminSteps {
    ...
    public void superAdminToUpdateDataByClickingOnTheActionButtonWithAPencilIcon() throws Throwable {
        SuperAdmin superAdmin = new SuperAdmin(webDriver);
        superAdmin.setPoepleSkill();
        Thread.sleep(2000);
    }

    @And("Super admin to deleting data by clicking on the action button with a pencil icon for delete data")
    public void superAdminToDeleteDataByClickingOnTheActionButtonWithAPencilIcon() throws Throwable {
        SuperAdmin superAdmin = new SuperAdmin(webDriver);
        superAdmin.setPoepleSkill();
        Thread.sleep(2000);
    }

    // End Super Admin_Shidiq
